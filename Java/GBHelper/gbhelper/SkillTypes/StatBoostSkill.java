...
public class StatBoostSkill extends StatChangingSkill {
	String statisticFirst, statisticSecond;
	int amountFirst, amountSecond, length;
	String statisticToCheck;
	int checkStatReduction;
	public StatBoostSkill(String target, String name, String description, int bank, int checkStatReduction, int length, String statisticToCheck,
			String statisticFirst, int amountFirst, String statisticSecond, int amountSecond) {
		super(target, name, description, bank, 5);
	...
	public Data construct(String[] values) {
		return new StatBoostSkill(values[0], values[1], values[2], Integer.parseInt(values[3]),
